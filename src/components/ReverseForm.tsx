...
export default function ReverseForm({ onSubmit }: ReverseFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div>
        <Label htmlFor="ip" hint="e.g. 1.2.3.4">
          IPv4
        </Label>
        <Input
          disabled={submitting}
          ...
          name="ip"
          type="text"
          pattern="^(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[1-9])\.(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])$"
          required
          value={ip}
          onChange={handleChange}
        />
